        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Pack Number</th>
                            <th scope="col" class="px-4 py-3">Donor name</th>
                            <th scope="col" class="px-4 py-3">Blood Group</th>
                            <th scope="col" class="px-4 py-3">Resus</th>
                            <th scope="col" class="px-4 py-3">Manufacture</th>
                            <th scope="col" class="px-4 py-3">Expire</th>
